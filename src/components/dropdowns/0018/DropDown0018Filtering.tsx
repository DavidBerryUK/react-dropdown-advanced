...
const version = "18";
const className = "demo-0018";
const title = "Filtering";
const description = "Advanced Filtering";

interface IProperties {
  width?: number;
}

const DropDown0018Filtering: React.FC<IProperties> = (props) => {
  const {
    //
    // STATE
    //
...
export default DropDown0018Filtering;
